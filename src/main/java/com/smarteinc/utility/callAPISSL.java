...
public class callAPISSL implements Callable<JSONObject> {
	...
	public callAPISSL(JSONObject jsonstring, String mode, String key, String url, String clientId, String inputValue, String evValue, String scopeValue, String outputValue) {
		super();
